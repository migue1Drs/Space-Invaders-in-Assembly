...
The software is structured using modular segments to ensure separation between code, data, and stack:
...
Input Handling: Direct monitoring of keyboard buffer via BIOS interrupts to ensure low-latency response for player movement and firing mechanics.
